package net.ritana5.rushmode.utils;
...
public class Utils {
    ...
    public static void sendActionBar1058(Player player, String message) {
        ...
        RushMode.bw1058Api.getVersionSupport().playAction(player, color(message));
    }

    public static void sendActionBar2023(Player player, String message) {
        JavaPlugin.getPlugin(RushMode.class);
        RushMode.bw2023Api.getVersionSupport().playAction(player, color(message));
    }
